...
```json
{
  ...
  "Help": {
    "ExpectedBody": {
      ...
      "FilterType": "string (optional) \u2014 which counter to filter by",
      "StartDate": "string (optional) \u2014 range start, ISO format YYYY-MM-DD",
      "EndDate": "string (optional) \u2014 range end, ISO format YYYY-MM-DD"
    }
  },
  "Code": 400
}
